...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2021 at 03:58 PM
...
(23, 'userv', 'userv', '827ccb0eea8a706c4c34a16891f84e7b', 'a@gmail.com', 0),
(25, 'test test ', 'test', '827ccb0eea8a706c4c34a16891f84e7b', 'test@gmail.com', 0),
(26, 'test1', 'test1', '827ccb0eea8a706c4c34a16891f84e7b', 'test@g.com', 0),
(27, 'test3', 'test3', '827ccb0eea8a706c4c34a16891f84e7b', 'test3@f.com', 0);
...
INSERT INTO `vaccine_registration` (`vaccine_id`, `fullname`, `address`, `phone`, `gender`, `dateofbirth`, `profile_pic`) VALUES
(24, 'Rickey ', 'Juniper Drive Mount Pleasant', '989-857-4840', 'male', '2021-09-29', ''),
(27, 'Almeida', 'Stuart Street Indiana, PA ', '724-465-0117', 'Female', '2021-10-19', 'covid-neg.jpg'),
(28, 'Aragon', 'Richland Avenue Sugar Land, TX', '281-266-1787', 'Female', '2021-10-05', 'covid-neg.jpg');
...
--
ALTER TABLE `appointment`
  MODIFY `appointment_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `vaccine_registration`
  MODIFY `vaccine_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
COMMIT;
