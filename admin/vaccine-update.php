...
?>
                <form  action="<?php $_SERVER['PHP_SELF']?>" method ="POST">
                      <div class="form-group">
                          <input type="hidden" name="vaccine_id"  class="form-control" value="<?php echo $row['vaccine_id'] ?>" placeholder="" >
                      </div>
                      <div class="form-group">
                          <label for="title">Full Name</label>
                          <input type="text" name="m_name" class="form-control" id="title" value="<?php echo $row['fullname'] ?>" placeholder="" required>
                      </div> 
                      <div class="form-group">
                          <label for="price">Present Address</label>
                          <input type="text" name="m_address" class="form-control" id="address" value="<?php echo $row['address'] ?>" placeholder="" required>
                      </div> 
                    <div class="form-group">
                      <label for="birth">Date of Birth</label>
                      <input type="date" name="m_birth" class="form-control" id="dateofbirth" value="<?php echo $row['dateofbirth'] ?>"> 
                    </div>
                    <div class="form-group">
