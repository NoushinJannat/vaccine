                ...
                <div class="card-body">
                  ...
                  <form action="" method="post" autocomplete="off" enctype="multipart/form-data">  
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="m_name" class="form-control" id="name" placeholder="Full Name"> 
                    </div>
                    <div class="form-group">
                      <label for="address">Present Address</label>
                      <input type="text" name="m_address" class="form-control" id="address" placeholder="Enter Present Address">
                    </div>
                    <div class="form-group">
