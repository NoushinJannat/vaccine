...
?>
      ...
      <div class="content-wrapper" data-aos="fade-left" data-aos-duration="1000">
        ...
        <div class="content"> 
        <!-- end: row (2nd)-->
        <h5 class="text-capitalize pb-3"> <i class="mdi mdi-hospital-building"></i> <?php echo $row['hospital_name']; ?> </h5> 
                  ...
                  <div class="card">
                    <div class="card-body"> 
                        <div class="media-body">
                          <p class="f-w-500">Patient Statistics <span class="f-w-700 font-primary ml-2">78.34%</span></p>  
                        </div>
