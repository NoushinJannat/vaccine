              ...
              $count = mysqli_num_rows($result);
                ...
                ?>
                        <tr>
                          ...
                          <?php if($_SESSION['role'] == 1){  ?>  
                          <td class="col-1">                              
                            <a href="appointment-update.php?id=<?php echo $row['appointment_id'] ?>" class="edit"> <i class="mdi mdi-square-edit-outline"></i></a> 
                            <a onclick="return confirm('Are You Sure?')" href='appointment-delete.php?id= <?php echo $row['appointment_id'] ?>'><i class='mdi mdi-delete-outline'></i></a>
                          </td>
                          <?php } ?>
                        </tr>
                <?php 
