      ...
      <div id="sidebar" class="sidebar sidebar-with-footer">
        ...
        <div class="sidebar-scrollbar">
          ...
          <ul class="nav sidebar-inner" id="sidebar-menu">
              ...
              <li class="<?php if($page=='vaccine-table'){echo 'active';}?>">
                <a class="sidenav-item-link" href="vaccine-table.php">
                  <i class="mdi mdi-walk"></i>
                  <span class="nav-text">Vaccinated List</span></b>
                </a>
              </li>
              ...
              <?php if($_SESSION['role'] == 0){  ?>     
                ...
                <li class="<?php if($page=='vaccine-form'){echo 'active';}?>">
              ...
              <?php if($_SESSION['role'] == 0){  ?>     
              <li class="<?php if($page=='appointment-form'){echo 'active';}?>">
              ...
              <li class="<?php if($page=='appointment-table'){echo 'active';}?>">
              ...
              <li class="<?php if($page=='hospital'){echo 'active';}?>">
