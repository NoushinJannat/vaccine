                        ...
                        <tr>
                          ...
                          <td class="col-1"> 
                            <div class="cartificate_image"> 
                              ...
                              <img width="70px" src="assets/images/<?php echo $row['profile_pic']; ?>" alt="" onerror="this.style.display='none'" /> 
                      


                              <?php if($_SESSION['role'] == 0){  ?>  
                              <div class="cartificate_zoom"> 
                                <a class="popup-link" href="assets/images/<?php echo $row['profile_pic']; ?>">  <i class="mdi mdi-magnify-plus-outline"></i>  </a>
                                <a download target="_blank" class="cert_download" href="assets/images/<?php echo $row['profile_pic']; ?>">  <i class="mdi mdi-download"></i>  </a>
                              </div> 
                              <?php } ?>
                               
                            </div> 
                            <?php if($_SESSION['role'] == 1){  ?>  
                              <button type="button" class="btn btn-certificate" data-toggle="modal" data-target="#delete<?php echo $id;?>">Add Certificate</button>
                            <?php } ?>
                          </td> 
                          ...
                          <td class="col-1">                              
                            <a href="vaccine-update.php?id=<?php echo $row['vaccine_id'] ?>" class="edit"> <i class="mdi mdi-square-edit-outline"></i></a> 
                          ...
                          <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-header">
                              ...
                              <div class="modal-body">
                                  <form action="add-certificate.php<?php echo '?vaccine_id='.$id; ?>" method="post" enctype="multipart/form-data">
                                    <br>
                                    ...
                                    <button type="submit" name="submit" class="btn btn-certificate">Upload</button>
                                  </form>
                              </div> 
                            </div>
                          </div>
